...
\begin{figure}
\centering
\includegraphics[width=0.95\linewidth]{figures/SURI_Poster.pdf}
...
\caption{Accuracy comparison showing concise prompts consistently outperform verbose across all reasoning strategies.}
\end{figure}
