...
\author{Kadin Matotek \texorpdfstring{\\[0.3em] \normalsize Advisors: Dr. Linh B. Ngo and Dr. Md Amiruzzaman}{, Advisor: Dr. Linh B. Ngo and Dr. Md Amiruzzaman}}
...
\begin{itemize}
  \item \textbf{0.5B model:} +21.0\% relative improvement
  \item \textbf{1.5B, 3B models:} +8.2\% and +8.3\% improvement
  \item \textbf{7B, 14B models:} +5.7\% and +0.4\% improvement
\end{itemize}
